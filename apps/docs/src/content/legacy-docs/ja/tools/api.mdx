...
| 名前 | 場所 | 必須 | 型 | 説明 |
| :--- | :------- | :------- | :--- | :---------- |
| **`gitProviderConfig`** | body | true | undefined | Git プロバイダー |
...
| 名前 | 場所 | 必須 | 型 | 説明 |
| :--- | :------- | :------- | :--- | :---------- |
| **`labels`** | query | undefined | string | JSONエンコードされたラベル |
...
ワークスペース内のファイルの所有者/グループ/権限を設定する
...
ワークスペース内の複数のファイルでテキスト/パターンを置換する
...
ワークスペース内のgitリポジトリからブランチリストを取得する
