...
コード補完、シンボル検索などのIDE風機能を提供するため、コードインテリジェンス用のLanguage Server Protocol機能を提供します。
...
- `path` _str_ - 開かれたファイルへのパス。相対パスは、LSPサーバーコンストラクターで設定された
  プロジェクトパスに基づいて解決されます。
...
- `path` _str_ - 閉じられたファイルへのパス。相対パスは、LSPサーバーコンストラクターで設定された
  プロジェクトパスに基づいて解決されます。
...
- `path` _str_ - シンボルを取得するファイルへのパス。相対パスは、LSPサーバーコンストラクターで設定された
  プロジェクトパスに基づいて解決されます。
